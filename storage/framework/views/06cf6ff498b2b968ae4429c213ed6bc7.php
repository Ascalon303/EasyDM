<?php $__env->startSection('title', 'Creator Content'); ?>
<?php $__env->startSection('page-title', 'Creator Marketplace'); ?>
...
<div class="max-w-6xl mx-auto">
    ...
    <div class="deco-border bg-gradient-to-r from-stone-900 to-stone-800 rounded-xl p-6 mb-8 flex items-center justify-between">
        ...
        <?php if(auth()->user()->isCreator() || auth()->user()->isAdmin()): ?>
        <a href="<?php echo e(route('creator-content.create')); ?>"
    ...
    <form method="GET" action="<?php echo e(route('creator-content.index')); ?>" class="mb-6 flex flex-wrap gap-3">
            ...
            <div class="px-5 pt-5 pb-3">
                <div class="flex items-start justify-between gap-2 mb-3">
                    <span class="text-xs px-2 py-0.5 rounded font-cinzel border
                        <?php if($content->type==='campaign_pack'): ?> border-gold-500/30 text-gold-400
                        <?php elseif($content->type==='monster'): ?> border-crimson-500/30 text-crimson-400
                        <?php elseif($content->type==='spell'): ?> border-arcane-500/30 text-arcane-400
                        <?php else: ?> border-green-500/30 text-green-400 <?php endif; ?>">
                        <?php echo e(strtoupper(str_replace('_',' ',$content->type))); ?>

                    </span>
                    <?php if($content->is_premium): ?>
                    <span class="text-xs px-2 py-0.5 bg-gold-500/20 border border-gold-500/30 text-gold-400 font-cinzel rounded">PREMIUM</span>
                    <?php endif; ?>
                </div>

                <h3 class="font-cinzel text-stone-100 font-bold text-lg leading-tight"><?php echo e($content->title); ?></h3>
                <p class="text-stone-500 text-sm font-crimson mt-2 leading-relaxed line-clamp-3">
                    <?php echo e($content->description ?? 'No description provided.'); ?>
            ...
            <div class="px-5 pb-5 pt-3 border-t border-stone-800 flex items-center justify-between">
                <div>
                    <div class="text-gold-400 font-cinzel font-bold text-lg">
                        <?php echo e($content->price > 0 ? '$' . number_format($content->price, 2) : 'FREE'); ?>

                    </div>
                    <div class="text-stone-600 text-xs font-cinzel">by <?php echo e($content->creator->name); ?></div>
                </div>
                <div class="flex items-center gap-2">
                    <?php if($content->rating > 0): ?>
                    <div class="text-xs text-gold-400 font-cinzel">★ <?php echo e(number_format($content->rating, 1)); ?></div>
                    <?php endif; ?>
                    <a href="<?php echo e(route('creator-content.show', $content)); ?>"
    ...
    <div class="mt-8"><?php echo e($contents->links()); ?></div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\easydm\easydm_full\resources\views/creator/index.blade.php ENDPATH**/ ?>