...
<?php $__env->startSection('page-title', 'Edit Content'); ?>
...
<div class="max-w-2xl mx-auto">
    <div class="deco-border bg-stone-900 rounded-xl p-8">
        ...
        <form method="POST" action="<?php echo e(route('creator-content.update', $creatorContent)); ?>" class="space-y-6">
            <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>

            <div>
                <label class="block text-stone-400 text-xs font-cinzel tracking-widest mb-2">TITLE *</label>
                <input type="text" name="title" value="<?php echo e(old('title', $creatorContent->title)); ?>" required
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <select name="type" class="w-full bg-stone-800 border border-stone-700 rounded-lg px-4 py-3 text-stone-100 text-sm outline-none">
                        ...
                        <option value="<?php echo e($val); ?>" <?php echo e(old('type',$creatorContent->type)===$val?'selected':''); ?>><?php echo e($label); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div>
                    <label class="block text-stone-400 text-xs font-cinzel tracking-widest mb-2">PRICE (USD)</label>
                    <input type="number" name="price" value="<?php echo e(old('price', $creatorContent->price)); ?>" min="0" step="0.01"
                           class="w-full bg-stone-800 border border-stone-700 rounded-lg px-4 py-3 text-stone-100 text-sm outline-none">
                </div>
            </div>

            <div class="flex items-center gap-3">
                <input type="checkbox" name="is_premium" id="is_premium" value="1" class="accent-gold-500 w-4 h-4" <?php echo e($creatorContent->is_premium?'checked':''); ?>>
            ...
            <div>
                ...
                <textarea name="description" rows="5"
                          class="w-full bg-stone-800 border border-stone-700 rounded-lg px-4 py-3 text-stone-100 text-sm outline-none resize-none font-crimson text-base"><?php echo e(old('description', $creatorContent->description)); ?></textarea>
            </div>
            ...
            <div>
                ...
                <textarea name="content_body" id="content_body" rows="12"
                        class="w-full bg-stone-800 border border-stone-700 focus:border-gold-500/50 rounded-lg px-4 py-3 text-stone-100 text-sm outline-none resize-none font-crimson"><?php echo e(old('content_body', $creatorContent->content_body)); ?></textarea>
            </div>
            ...
            <div class="flex gap-3">
                ...
                <a href="<?php echo e(route('creator-content.show', $creatorContent)); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\easydm\easydm_full\resources\views/creator/edit.blade.php ENDPATH**/ ?>