...
<div class="max-w-6xl mx-auto space-y-6">
    ...
    <div class="deco-border bg-stone-900 rounded-xl p-6 flex items-start justify-between gap-4">
        ...
        <?php if(auth()->id() === $campaign->user_id || auth()->user()->isAdmin()): ?>
    ...
    <div>
        ...
        <div class="bg-stone-900 rounded-xl deco-border overflow-hidden">
            ...
            <div class="flex items-center gap-4 px-5 py-3 <?php echo e(!$loop->last ? 'border-b border-stone-800' : ''); ?>">
                ...
                <?php if(auth()->id() === $campaign->user_id || auth()->user()->isAdmin()): ?>
                <form method="POST" action="<?php echo e(route('campaigns.kick', [$campaign, $player->id])); ?>"
                      onsubmit="return confirm('Kick <?php echo e($player->name); ?> from this campaign?')">
